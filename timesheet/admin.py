...
from .models import UserProfile, Project, TimeEntry, TimerSession
...
class ProjectAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'created_by', 'is_active', 'budget_hours', 'total_hours', 'approved_hours', 'created_at')
...
class TimeEntryAdmin(admin.ModelAdmin):
    ...
    list_display = ('user', 'project', 'date', 'duration_minutes', 'duration_hours', 'status', 'entry_type', 'created_at')
    list_filter = ('status', 'entry_type', 'date', 'project')
...
class TimerSessionAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('start_time', 'duration_minutes', 'duration_hours', 'elapsed_time')
